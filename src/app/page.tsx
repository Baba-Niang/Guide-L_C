...
import { ProductionRecipe } from "@/components/pedagogy/production-recipe";
import { productionRecipes } from "@/lib/production-recipes";
import {
  StoryBlock,
  AnalogyBlock,
  VocabBlock,
  ...
  return (
    <div ref={scrollRef} className="h-full overflow-y-auto">
      ...
      <div className="content-wide mx-auto px-4 md:px-8 py-7">
        ...
        {currentLevel !== "comprendre" && productionRecipes[chapter.id] && (
          <ProductionRecipe recipe={productionRecipes[chapter.id]} />
        )}
      ...
      {/* Bottom navigation: visible only when the learner reaches the end. */}
      <div ref={endRef} className="chapter-end-sentinel" aria-hidden="true" />
      {showBottomNav && <div className="chapter-foot-nav">
        <button
          onClick={prevChapter}
